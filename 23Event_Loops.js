...
//But, when some operation that we have to perform should have to be performed after some time and since call stack don't have any such tool to do so. . so for  some api that are provided by browsers(superPowers)
